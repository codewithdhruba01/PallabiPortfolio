...
- **Memory Polaroid Strip**: An interactive, nursing-themed photo gallery with aesthetic hover effects.
...
> [!NOTE]
> The `--legacy-peer-deps` flag is currently required due to a version conflict between `eslint@10` and certain TanStack plugins.
